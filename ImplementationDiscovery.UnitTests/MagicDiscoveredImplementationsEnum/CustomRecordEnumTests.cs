...
public class CustomRecordEnumTests
{
	...
	{
		Assert.Equal(nameof(CustomRecordEnumMock.ValueA), CustomRecordEnumMock.ValueA.Value.Instance.Text);
		Assert.Equal(nameof(CustomRecordEnumMock.ValueB), CustomRecordEnumMock.ValueB.Value.Instance.Text);

		Assert.Equal(nameof(CustomRecordEnumMock.ValueA), CustomRecordEnumMock.GetSingleMember(nameof(CustomRecordEnumMock.ValueA)).Value.Instance.Text);
		Assert.Equal(nameof(CustomRecordEnumMock.ValueB), CustomRecordEnumMock.GetSingleMember(nameof(CustomRecordEnumMock.ValueB)).Value.Instance.Text);
	}
