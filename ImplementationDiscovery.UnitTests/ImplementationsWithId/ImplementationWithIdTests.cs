...
public class ImplementationWithIdTests
{
    ...
    {
        Assert.Equal(nameof(ImplementationWithIdMock1), ImplementationWithIdMock1.StaticTypeId.Value);
        Assert.Equal(nameof(ImplementationWithIdMock2), ImplementationWithIdMock2.StaticTypeId.Value);
    }
}