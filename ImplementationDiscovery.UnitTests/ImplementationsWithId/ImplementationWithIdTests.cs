...
public class ImplementationWithIdTests
{
    ...
    {
        Assert.Equal(nameof(ImplementationWithIdMock1), ImplementationWithIdMockBaseEnum.ImplementationWithIdMock1.ImplementationId.Name);
        Assert.Equal(nameof(ImplementationWithIdMock2), ImplementationWithIdMockBaseEnum.ImplementationWithIdMock2.ImplementationId.Name);
    }
