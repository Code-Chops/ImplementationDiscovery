...
public class ImplementationWithGenericTypeTests
{
	...
	{
		Assert.Equal(nameof(ImplementationWithGenericTypeMock<int>),		ClassWithGenericTypeToImplementEnum<int>.ImplementationWithGenericTypeMock.UninitializedInstance.GetImplementationId().Name);
	}
