...
");
        ...
        string GetUsings()
        {
            var usings = definition.Usings.Concat(
            [
...
");
        ...
        string GetCreation(DiscoveredEnumMember member, EnumDefinition definition)
            ...
            {
                InstanceCreationMethod.Factory       => $"new DiscoveredObject<{definition.BaseTypeNameIncludingGenerics}>(() => {member.Value}.Create())",
                InstanceCreationMethod.New           => $"new DiscoveredObject<{definition.BaseTypeNameIncludingGenerics}>(() => new {member.Value}())",
