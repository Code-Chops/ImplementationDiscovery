...
public record EnumDefinition
{
	...
	/// </summary>
	public string? ValueTypeDefinition { get; }
	...
	public EnumDefinition(string name, string? enumNamespace, string valueTypeName, string valueTypeNamespace, DiscoverabilityMode discoverabilityMode, 
		string filePath, string accessModifier, IEnumerable<EnumMember> attributeMembers, bool isStruct, string? valueTypeDefinition = null)
	{
		this.Name = name;
