...
internal record EnumDefinition : IEnumModel
{
    ...
    {
        const string baseTypeName = nameof(Object);
        ...
        string filePath, AttributeData attribute, EnumDefinition? externalDefinition)
    {
        ...
        var customName = attribute.GetArgumentOrDefault<string>("enumName", defaultValue: null);
    ...
    private static string GetName(string? customName, string name, bool isProxy)
    {
