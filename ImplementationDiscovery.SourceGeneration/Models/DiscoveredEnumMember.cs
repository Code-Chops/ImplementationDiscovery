...
internal record DiscoveredEnumMember : EnumMember
{
    ...
    public DiscoveredEnumMember(string enumIdentifier, string name, bool isPartial, string? @namespace,
        string declaration, string value, string filePath, LinePosition linePosition, string? typeParameters,
        bool isConvertibleToConcreteType, string accessibility, InstanceCreationMethod instanceCreationMethod,
        bool hasComments)
