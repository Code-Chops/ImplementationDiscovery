	...
	where TBaseType : class
{
	...
	protected static TSelf CreateMember(TValue value) 
		=> MagicEnumCore<TSelf, TValue>.CreateMember(valueCreator: () => value, memberCreator: () => new TSelf(), name: GetNameWithoutBacktick(value));
	...
	public static TSelf GetOrCreateMember(TValue value) 
		=> MagicEnumCore<TSelf, TValue>.GetOrCreateMember(valueCreator: () => value, memberCreator: () => new TSelf(), name: GetNameWithoutBacktick(value));
